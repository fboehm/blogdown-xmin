...
While browsing the internet, I stumbled upon Rstudio's new package `blogdown`. I read [posts from Karl Broman](http://kbroman.org/blog/) and found the [the book](https://bookdown.org/yihui/blogdown/) that the package authors - Yihui Xie and Amber Thomas - freely share.
